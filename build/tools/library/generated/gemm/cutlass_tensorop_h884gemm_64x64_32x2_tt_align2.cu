...
// Define named type
struct cutlass_tensorop_h884gemm_64x64_32x2_tt_align2 : 
  public cutlass_tensorop_h884gemm_64x64_32x2_tt_align2_base { };
...
void initialize_cutlass_tensorop_h884gemm_64x64_32x2_tt_align2(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_h884gemm_64x64_32x2_tt_align2>
    >("cutlass_tensorop_h884gemm_64x64_32x2_tt_align2"));
