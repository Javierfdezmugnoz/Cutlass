...
using cutlass_tensorop_h884gemm_128x64_32x2_nt_align1_base = 
...
// Define named type
struct cutlass_tensorop_h884gemm_128x64_32x2_nt_align1 : 
  public cutlass_tensorop_h884gemm_128x64_32x2_nt_align1_base { };
...
void initialize_cutlass_tensorop_h884gemm_128x64_32x2_nt_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_tensorop_h884gemm_128x64_32x2_nt_align1>
    >("cutlass_tensorop_h884gemm_128x64_32x2_nt_align1"));
