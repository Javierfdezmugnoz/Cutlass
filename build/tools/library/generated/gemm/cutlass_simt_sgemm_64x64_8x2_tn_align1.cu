...
using cutlass_simt_sgemm_64x64_8x2_tn_align1_base = 
...
// Define named type
struct cutlass_simt_sgemm_64x64_8x2_tn_align1 : 
  public cutlass_simt_sgemm_64x64_8x2_tn_align1_base { };
...
void initialize_cutlass_simt_sgemm_64x64_8x2_tn_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmUniversalOperation<
      cutlass::gemm::device::GemmUniversalAdapter<cutlass_simt_sgemm_64x64_8x2_tn_align1>
